...
parser = argparse.ArgumentParser(description='MRFT')
...
parser.add_argument('--data_test', type=str, default='Sintel',
...
parser.add_argument('--model', default='mrft',
                    help='model name')
...
parser.add_argument('--test_every', type=int, default=5012,
...
parser.add_argument('--lr', type=float, default=1e-4,
                    help='learning rate')
parser.add_argument('--lr_decay', type=str, default='50',
...
# Log specifications
parser.add_argument('--save', type=str, default='test_stage2',
                    help='file name to save')
parser.add_argument('--load', type=str, default='test_stage2',
